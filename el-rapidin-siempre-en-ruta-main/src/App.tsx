      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<UserLayout />}>
            ...
            <Route
              path="/servicios/motocarguero"
              element={<MotocargueroPage />}
            />
            ...
            <Route
              path="/orden/calificar/:orderId"
              element={<CalificarOrdenPage />}
            />
          ...
          {/* Domiciliario Routes */}
          <Route
            path="/domiciliario/login"
            element={<LoginDomiciliarioPage />}
          />
          <Route path="/domiciliario" element={<DomiciliarioLayout />}>
            ...
            <Route
              path="pedido/:id"
              element={<PedidoDetalleDomiciliarioPage />}
            />
