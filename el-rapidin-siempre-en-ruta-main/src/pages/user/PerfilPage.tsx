...
const PerfilPage = () => {
  ...
  /* 🔹 Sincroniza datos reales del usuario */
  useEffect(() => {
    if (!user) return;
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center gap-6">
              <div className="relative">
                ...
                {isEditing && (
                  <label className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-accent text-accent-foreground flex items-center justify-center cursor-pointer">
